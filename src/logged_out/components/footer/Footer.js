...
const infos = [
  {
    icon: <PhoneIcon />,
    description: "963 738 532"
  },
  {
    icon: <MailIcon />,
    description: "info@ruwaytech.com"
  }
];
...
const socialIcons = [
  {
    ...
    label: "Github",
    href: "https://github.com/cnvillegaschavez"
  },
  {
    icon: (
      <svg
    ...
    label: "Facebook",
    href: "https://www.facebook.com/ruwaytech.srl"
  },
  {
    icon: (
      <svg
    ...
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/cristianvillegas"
  },
  {
    icon: (
      <svg
    ...
    label: "Twitter",
    href: "https://www.twitter.com/cvillegaschavez"
  }
];
              ...
              <Box mb={1}>
                ...
                <Box mb={1}>
                  <TextField
                    ...
                    inputProps={{ "aria-label": "Get in Touch",  maxLength:800}}
                    InputProps={{
                      className: classes.whiteBg                      
                    }}
                    rows={4}
